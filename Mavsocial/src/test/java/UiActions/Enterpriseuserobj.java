...
public class Enterpriseuserobj extends TestBase
{
    ...
    @FindBy(how = How.CLASS_NAME, using = "profilepic")
    WebElement profile; //Web Element  For profile click 
    
    
    @FindBy(how = How.LINK_TEXT, using = "profile")
    WebElement profile1; //Web Element  For profile click 
    
    @FindBy(how = How.XPATH, using = "//li[1]//div[2]")
    ...
    @FindBy(how = How.LINK_TEXT, using = "Publish")
    ...
    public void enterpriseuseroperations(String username, String password) throws Exception
    {
      ...
      a.moveToElement(postmgr).click(postmgr).build().perform();
